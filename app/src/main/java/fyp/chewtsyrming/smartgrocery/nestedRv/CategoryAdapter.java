...
public class CategoryAdapter extends RecyclerView.Adapter<CategoryAdapter.HomeViewHolder> {
    ...
    public void onBindViewHolder(@NonNull HomeViewHolder holder, final int position) {
        ...
        holder.recyclerViewHorizontal.addOnItemTouchListener(new RecyclerTouchListener(context, holder.recyclerViewHorizontal, new RecyclerTouchListener.ClickListener() {
